import { ActionPlan, ActionPlans, CurrentActionInfo, EssentialCurrentAction } from '../types/action';
import { RequestActionPlans } from '../types/storage';
...
const localStorageManager = {
  ...
  get actorInfo(): MemberInfo {
    const actionPlansStr = localStorage.getItem(this.ACTION_PLANS);
    console.log(typeof actionPlansStr);
